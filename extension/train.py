...
save_dir = os.path.join(base_path, 'checkpoints_ext_change')
...
def main():
    checkpoint_path = os.path.join(save_dir, 'checkpoint_ext_change.pth')
    var_model = "STDC1"
    best_miou = 0
    start_epoch = 1
    init_lr = 2.5e-2
    project_name = f"{var_model}prova_ext_change"
