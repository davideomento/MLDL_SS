...
save_dir = os.path.join(base_path, 'checkpoints_adversarial_official_official')
...
target_dataloader = DataLoader(train_target_dataset, batch_size=8, shuffle=True, num_workers=2)
